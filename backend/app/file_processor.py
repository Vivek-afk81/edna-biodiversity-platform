...
#     #         for seq_name in fasta_file:
#     #             sequence = fasta_file[seq_name]
#     #             seq_dict = {
#     #                 'id': seq_name,
#     #                 'description': sequence.description if hasattr(sequence, 'description') else '',
#     #                 'sequence': str(sequence),
#     #                 'length': len(sequence),
#     #                 'gc_content': self.calculate_gc_content(str(sequence)),
#     #                 'n_content': str(sequence).upper().count('N'),
#     #                 'quality_score': self.calculate_quality_score(str(sequence))
#     #             }
